...
RCT_EXPORT_METHOD(addSegment:(NSInteger)key values:(NSArray *)values resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject)
{
    if ( [self isPluginInitialized] )
    {
...
RCT_EXPORT_METHOD(createBannerWithOffsets:(NSString *)adUnitIdentifier position:(NSString *)bannerPosition xOffset:(float)xOffset yOffset:(float)yOffset)
{
    if ( !self.sdk )
    {
...
RCT_EXPORT_METHOD(updateBannerOffsets:(NSString *)adUnitIdentifier xOffset:(float)xOffset yOffset:(float)yOffset)
{
    if ( !self.sdk )
    {
...
RCT_EXPORT_METHOD(setBannerWidth:(NSString *)adUnitIdentifier width:(NSInteger)width)
{
    if ( !self.sdk )
    {
...
RCT_EXPORT_METHOD(getAdaptiveBannerHeightForWidth:(float)width resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject)
{
...
RCT_EXPORT_METHOD(destroyNativeUIComponentAdView:(NSInteger)adViewId
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject)
{
