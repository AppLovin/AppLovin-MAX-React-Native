...
export interface Spec extends TurboModule {
    ...
    addSegment(key: Int32, values: Int32[]): Promise<void>;

    getSegments(): Promise<Map<string, Int32[]> | null>;

    createBanner(adUnitId: string, position: string): void;

    createBannerWithOffsets(adUnitId: string, position: string, xOffset: Float, yOffset: Float): void;
    ...
    setBannerWidth(adUnitId: string, width: Float): void;

    updateBannerPosition(adUnitId: string, position: string): void;

    updateBannerOffsets(adUnitId: string, xOffset: Float, yOffset: Float): void;
    ...
    getAdaptiveBannerHeightForWidth(width: Float): Promise<number>;
    ...
    destroyNativeUIComponentAdView(adViewId: Int32): Promise<void>;
