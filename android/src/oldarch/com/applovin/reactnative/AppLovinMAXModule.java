    ...
    extends ReactContextBaseJavaModule
{
    ...
    {
        impl.addSegment( key, values, promise );
    }
    ...
    @ReactMethod
    public void createBannerWithOffsets(final String adUnitId, final String position, final float xOffset, final float yOffset)
    {
        impl.createBannerWithOffsets( adUnitId, position, xOffset, yOffset );
    }
    ...
    @ReactMethod
    public void setBannerWidth(final String adUnitId, final int width)
    {
        impl.setBannerWidth( adUnitId, width );
    }
    ...
    @ReactMethod
    public void updateBannerOffsets(final String adUnitId, final float xOffset, final float yOffset)
    {
        impl.updateBannerOffsets( adUnitId, xOffset, yOffset );
    }
    ...
    {
        impl.getAdaptiveBannerHeightForWidth( width, promise );
    }
    ...
    {
        impl.destroyNativeUIComponentAdView( adViewId, promise );
    }
