    ...
    implements AppLovinMAXNativeAdViewManagerInterface<AppLovinMAXNativeAdView>
{
    ...
    public void setLocalExtraParameters(final AppLovinMAXNativeAdView view, @Nullable final ReadableArray value)
    {
    ...
    @Override
    public void updateAssetView(final AppLovinMAXNativeAdView view, final int assetViewTag, final String assetViewName)
    {
        AppLovinMAXNativeAdViewManagerImpl.updateAssetView( view, assetViewTag, assetViewName );
    }
